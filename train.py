...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Backbone architecture for ResTran. Use 'timm:<model_name>' for TIMM models (e.g., 'timm:swinv2_base_window12_192.ms_in22k:0') or standard choices like resnet/convnext variants.",
    )
    parser.add_argument(
        "--backbone-variant",
        type=str,
...
def main():
    ...
    common_ds_params = {
        ...
        "input_norm": getattr(config, "INPUT_NORM", "imagenet"),
